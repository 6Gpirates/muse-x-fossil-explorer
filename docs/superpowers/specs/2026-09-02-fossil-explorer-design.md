...
3. 생존 연대 및 주요 적응 특징: [예: 약 75,000년 전 후기 플라이스토세 빙하기 적응 - 두꺼운 흰색
...
correctAnswer, displayAge, era, explanation }` 형식. (지질시대 라벨 2건은 선생님 승인 하에
과학적으로 정정함 — 2026-09-02):
1. ¹⁴C→¹⁴N, 1:1, 50% → 5,700년 전 (신생대 제4기 홀로세)  ← 정정: 후기 플라이스토세→홀로세
2. ²³⁰Th 계열, 1:1, 50% → 75,000년 전 (신생대 제4기 후기 플라이스토세)  ← 정정: 중기→후기
